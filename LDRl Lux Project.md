...
* Resistor 10k Ohm (sebagai pembagi tegangan / *voltage divider*)
* Multimeter (opsional untuk pemantauan tegangan di Tinkercad)
* Kabel Jumper

## 🔌 Skema Rangkaian (Wiring)
Berikut adalah konfigurasi pin yang digunakan pada *project* ini:
